...
def InitiateBox(game: dict, Data: dict, sender: str, programMap: str, mapPole: str) -> tuple[dict, str]:
    ...
    if sender == 'MainFunction':
        ...
        programMap += f'                   ╞╾ParseBox.InitiateBox╼╮\n'
    ...
    home = game['homeTeam']
    away = game['awayTeam']    
    home['Wins'] = Data['HomeTeam']['wins']
    home['Losses'] = Data['HomeTeam']['losses']
    home['Seed'] = Data['HomeTeam']['seed']
    away['Wins'] = Data['AwayTeam']['wins']
...
def FormatTeamBox(SeasonID: int, GameID: int, TeamID: int, MatchupID: int, team: dict) -> dict:
    ...
    TeamBox = {
        ...
        'SecondChanceFGM': team['statistics']['secondChancePointsMade'],
        'SecondChanceFGA': team['statistics']['secondChancePointsAttempted'],
        'SecondChanceFG%': team['statistics']['secondChancePointsPercentage'],
        'TrueShootingAttempts': team['statistics']['trueShootingAttempts'],
        'TrueShootingPercentage': team['statistics']['trueShootingPercentage'],
        'PtsFromTurnovers': team['statistics']['pointsFromTurnovers'],
        'PtsSecondChance': team['statistics']['pointsSecondChance'],
        'PtsInThePaint': team['statistics']['pointsInThePaint'],
        'PaintFGM': team['statistics']['pointsInThePaintMade'],
        'PaintFGA': team['statistics']['pointsInThePaintAttempted'],
        'PaintFG%': team['statistics']['pointsInThePaintPercentage'],
        'PtsFastBreak': team['statistics']['pointsFastBreak'],
        'FastBreakFGM': team['statistics']['fastBreakPointsMade'],
        'FastBreakFGA': team['statistics']['fastBreakPointsAttempted'],
        'FastBreakFG%': team['statistics']['fastBreakPointsPercentage'],
