...
def InitiatePlayByPlay(SeasonID: int, GameID: int, HomeID: int, AwayID: int, actions: list, startPosition: int, sender: str, homeStarters, awayStarters):
    ...
    StintID = 1
    homeLineup = homeStarters.copy() #Copy Home Starting Lineup to HomeLineup
    awayLineup = awayStarters.copy() #Copy Away Starting Lineup to AwayLineup
    homeStats, awayStats = CreateTeamStats(SeasonID, GameID, HomeID, AwayID, homeLineup, awayLineup, StintID)
...
#region Stat Dictionary Creations
def CreateTeamStats(SeasonID, GameID, HomeID, AwayID, homeLineup, awayLineup, stintID):
    ...
    homeStats['Lineup'] = {player: CreatePlayerStats(player, HomeID, SeasonID, GameID, stintID) for player in homeLineup}
    awayStats = teamStats.copy()
    awayStats['TeamID'] = AwayID
    awayStats['Lineup'] = {player: CreatePlayerStats(player, AwayID, SeasonID, GameID, stintID) for player in awayLineup}
